            ...
            <div class="col-md-06">
                ...
                <div class="card mt-4 border-0 shadow-sm bg-light">
                    <div class="card-body small text-muted">
                        <i class="bi bi-info-circle me-1"></i> New admins will have access to the dashboard and management
                        tools. They will be assigned the <strong>admin</strong> role by default.
                    </div>
                </div>
            </div>
        </div>
