...
@section('content')
    <div class="container-fluid py-4 animate-fade-in">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 class="h3 fw-bold text-dark mb-1">Add New Brand</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        ...
                        <li class="breadcrumb-item active text-primary fw-medium" aria-current="page">New Brand</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-xl-8">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                    <div class="card-header bg-white border-bottom border-light py-4 px-4">
                        <h5 class="mb-0 fw-bold text-dark">Brand Details</h5>
                        <p class="text-muted small mb-0 mt-1">Fill in the information to register a new brand.</p>
                    </div>
                        ...
                        <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="logo-preview-container" class="mb-3 d-none text-center">
                                        <img id="logo-preview" src="#" alt="Preview" class="img-thumbnail rounded-4 shadow-sm" style="max-height:120px">
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" id="description"
                                        ...
                                        rows="4" placeholder="Brief description of the brand...">{{ old('description') }}</textarea>
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-primary rounded-pill px-5 py-3 fw-bold w-100 shadow-lg">
                                        <i class="bi bi-check-lg me-2"></i>Save Brand
                                    </button>
                                </div>
                            </div>
                        </form>
