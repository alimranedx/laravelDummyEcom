...
@section('content')
    <div class="container-fluid py-4 animate-fade-in">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 class="h3 fw-bold text-dark mb-1">Create Category</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        ...
                        <li class="breadcrumb-item active text-primary fw-medium" aria-current="page">New Category</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control bg-light border-0 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Smartphones">
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control bg-light border-0 @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Brief description...">{{ old('description') }}</textarea>
