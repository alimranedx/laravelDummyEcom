...
@section('content')
    <div class="container-fluid py-4 animate-fade-in">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h1 class="h3 fw-bold text-dark mb-1">Edit User</h1>
            ...
            <div class="col-xl-8">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white mb-4">
                    <div class="card-header bg-white border-0 py-4 px-4 border-bottom border-light">
                        <h5 class="mb-0 fw-bold text-dark">Customer Profile</h5>
                        <p class="text-muted small mb-0 mt-1">Update the account information for this customer.</p>
                    </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control bg-light border-0 @error('name') is-invalid @enderror" 
                                               id="name" name="name" value="{{ old('name', $user->name) }}" placeholder="e.g. John Doe" required>
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="email" class="form-control bg-light border-0 @error('email') is-invalid @enderror" 
                                               id="email" name="email" value="{{ old('email', $user->email) }}" placeholder="user@example.com" required>
                                    </div>
                                    @error('email')
                                        <div class="invalid-feedback d-block mt-2">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-12">
                                    <h6 class="fw-bold text-dark mb-0 d-flex align-items-center">
                                        <i class="bi bi-shield-lock me-2 text-primary"></i> Update Password
                                        <span class="badge bg-light text-muted fw-normal ms-2 border small">Optional</span>
                                    </h6>
                                    <p class="text-muted small mt-1 mb-0">Leave blank if you don't want to change the password.</p>
                                </div>
