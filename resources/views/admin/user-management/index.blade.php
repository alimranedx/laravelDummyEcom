    ...
    <div class="container-fluid py-4 animate-fade-in">
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
            <div class="card-header bg-white border-0 py-4 px-4 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                ...
                <form method="GET" action="{{ route('admin.user-management.index') }}" class="search-box position-relative d-flex gap-2 w-100" style="max-width: 400px;">
                    ...
                    @if(request()->filled('q'))
                        <a href="{{ route('admin.user-management.index') }}" class="btn btn-light rounded-pill border px-3">Clear</a>
                    @endif
                </form>
            </div>
            ...
            <div class="card-footer bg-white py-3 px-4 border-top">
                <div class="row align-items-center m-0">
                    <!-- Left: Showing X to Y -->
                    @include('common.pagination.pagination_data_show', ['data' => $users])
                    ...
                    @include('common.pagination.common_pagination', ['data' => $users])
                </div>
            </div>
