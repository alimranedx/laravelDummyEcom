    ...
    <div class="py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Manage customer accounts and details.</p>
            </div>
            <a href="{{ route('admin.user-management.create') }}" class="btn btn-primary btn-sm shadow-sm transition">
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light text-muted small text-uppercase">
                        <tr>
                            ...
                            <th class="px-4 py-3 border-0">Registered</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    ...
                                    No regular user accounts found.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
